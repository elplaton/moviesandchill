...
export default function MovieCard({
  ...
  downloaded, downloadState, hoverLabel, actions = 'play', focusKey,
}: MovieCardProps) {
  ...
  return (
    <div
      ...
      style={{
        transform: active ? 'scale(1.1) translateY(-4px)' : 'scale(1) translateY(0)',
        zIndex: active ? 20 : 1,
      }}
    ...
    >
      ...
      >
        ...
        {(!downloadState || downloadState.status === 'done' || downloadState.status === 'error') && active && (
